...
class _StrokeWidthToolOptionState extends ConsumerState<StrokeWidthToolOption> {
  ...
  void _onChangedTextField(String value) {
    ...
    ref
        .read(brushToolProvider.notifier)
  ...
  void _onChangedSlider(double newValue) {
    ...
    ref.read(brushToolProvider.notifier).updateStrokeWidth(newValue);
  }
  ...
  void initState() {
    ...
    _strokeWidthTextController = TextEditingController(
      text:
          ref.read(brushToolProvider).paint.strokeWidth.toInt().toString(),
    );
  }
  ...
  Widget build(BuildContext context) {
    final strokeWidth = ref.watch(brushToolProvider).paint.strokeWidth;
